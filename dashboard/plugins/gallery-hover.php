...
<!-- Mirrored from templates.iqonic.design/hope-ui/pro/html/dashboard/plugins/gallery-hover.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Jul 2023 04:40:00 GMT -->
<head>
        <meta charset="utf-8">
                   ...
                   <div class="container-fluid navbar-inner">
                      ...
                      <div class="d-flex align-items-center justify-content-between product-offcanvas">
                         <div class="breadcrumb-title border-end me-3 pe-3 d-none d-xl-block">
                            <small class="mb-0 text-capitalize">Gallery Hover</small>
                         </div>
        ...
        <div class="row">
          <div class="col-xl-3 col-lg-4 col-md-6 grid-m">
            <div class="hover-effects">
              <a href="#">
                <img src="../../assets/images/hover-effects/01.jpg" class="img-fluid rounded effect-1" alt="01.jpg"
                  loading="lazy" />
              </a>
            </div>
          </div>
          <div class="col-xl-3 col-lg-4 col-md-6 grid-m">
            <div class="hover-effects">
              <a href="#">
                <img src="../../assets/images/hover-effects/02.jpg" class="img-fluid rounded effect-2" alt="02.jpg" />
              </a>
            </div>
          </div>
          <div class="col-xl-3 col-lg-4 col-md-6 grid-m">
            <div class="hover-effects">
              <a href="#">
                <img src="../../assets/images/hover-effects/03.jpg" class="img-fluid rounded effect-3" alt="03.jpg"
                  loading="lazy" />
              </a>
            </div>
          </div>
          <div class="col-xl-3 col-lg-4 col-md-6 grid-m">
            <div class="hover-effects">
              <a href="#">
                <img src="../../assets/images/hover-effects/04.jpg" class="img-fluid rounded effect-4" alt="04.jpg"
                  loading="lazy" />
              </a>
            </div>
          </div>
          <div class="col-xl-3 col-lg-4 col-md-6 grid-m">
            <div class="hover-effects">
              <a href="#">
                <img src="../../assets/images/hover-effects/05.jpg" class="img-fluid rounded" alt="05.jpg"
                  loading="lazy" />
              </a>
          ...
          <div class="col-xl-3 col-lg-4 col-md-6 grid-m">
            <div class="hover-effects">
              <a href="#">
                <img src="../../assets/images/hover-effects/06.jpg" class="img-fluid rounded" alt="05.jpg"
                  loading="lazy" />
              </a>
          ...
          <div class="col-xl-3 col-lg-4 col-md-6 grid-m">
            <div class="hover-effects">
              <a href="#">
                <img src="../../assets/images/hover-effects/07.jpg" class="img-fluid rounded" alt="07.jpg"
                  loading="lazy" />
              </a>
          ...
          <div class="col-xl-3 col-lg-4 col-md-6 grid-m">
            <div class="hover-effects">
              <a href="#">
                <img src="../../assets/images/hover-effects/08.jpg" class="img-fluid rounded" alt="08.jpg"
                  loading="lazy" />
              </a>
          ...
          <div class="col-xl-3 col-lg-4 col-md-6 grid-m">
            <div class="hover-effects">
              <img src="../../assets/images/hover-effects/09.jpg" class="img-fluid rounded" alt="09.jpg"
                loading="lazy" />
              <div class="ovrlay-5">
          ...
          <div class="col-xl-3 col-lg-4 col-md-6 grid-m">
            <div class="hover-effects">
              <img src="../../assets/images/hover-effects/10.jpg" class="img-fluid rounded" alt="10.jpg"
                loading="lazy" />
              <div class="ovrlay-6">
          ...
          <div class="col-xl-3 col-lg-4 col-md-6 grid-m">
            <div class="hover-effects">
              <img src="../../assets/images/hover-effects/11.jpg" class="img-fluid rounded" alt="11.jpg"
                loading="lazy" />
              <div class="ovrlay-7">
                <a href="#" class="button">
          ...
          <div class="col-xl-3 col-lg-4 col-md-6 grid-m">
            <div class="hover-effects">
              <img src="../../assets/images/hover-effects/12.jpg" class="img-fluid rounded effect-8" alt="12.jpg"
                loading="lazy" />
              <div class="ovrlay-8">
...
<!-- Mirrored from templates.iqonic.design/hope-ui/pro/html/dashboard/plugins/gallery-hover.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Jul 2023 04:40:06 GMT -->
</html>
