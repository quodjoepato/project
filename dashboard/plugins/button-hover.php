...
<!-- Mirrored from templates.iqonic.design/hope-ui/pro/html/dashboard/plugins/button-hover.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Jul 2023 04:39:49 GMT -->
<head>
        <meta charset="utf-8">
                    ...
                    <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="sub-nav collapse" id="horizontal-menu" data-bs-parent="#sidebar-menu">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link "
                                        href="../index-dual-horizontal.html">
                                        <i class="icon">
                                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <g>
                            ...
                            <ul class="sub-nav collapse" id="e-commerce" data-bs-parent="#sidebar-menu">
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="sub-nav collapse" id="shop-main" data-bs-parent="#e-commerce">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link "
                                                href="https://templates.iqonic.design/hope-ui/pro/html/e-commerce/shop-right-filter.html">
                                                <i class="icon">
                                                    <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <g>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link product-grid" aria-current="page"
                                                href="https://templates.iqonic.design/hope-ui/pro/html/e-commerce/products.html?type=product-grid">
                                                <i class="icon">
                                                    <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <g>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link product-list" aria-current="page"
                                                href="https://templates.iqonic.design/hope-ui/pro/html/e-commerce/products.html?type=product-list">
                                                <i class="icon">
                                                    <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <g>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link "
                                                href="https://templates.iqonic.design/hope-ui/pro/html/e-commerce/categories-list.html">
                                                <i class="icon">
                                                    <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <g>
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="sub-nav collapse" id="products" data-bs-parent="#e-commerce">
                                        <li class="nav-item">
                                            <a class="nav-link "
                                                href="https://templates.iqonic.design/hope-ui/pro/html/e-commerce/product-detail.html">
                                                <i class="icon">
                                                    <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <g>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link "
                                                href="https://templates.iqonic.design/hope-ui/pro/html/e-commerce/product-detail-3d.html">
                                                <i class="icon">
                                                    <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <g>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link "
                                                href="https://templates.iqonic.design/hope-ui/pro/html/e-commerce/product-detail-360.html">
                                                <i class="icon">
                                                    <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <g>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link " aria-current="page"
                                        href="https://templates.iqonic.design/hope-ui/pro/html/e-commerce/invoice.html">
                                        <i class="icon">
                                            <svg width="20" class="icon-20" height="20" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path opacity="0.4"
                                ...
                                <li class="nav-item">
                                    <a class="nav-link "
                                        href="https://templates.iqonic.design/hope-ui/pro/html/e-commerce/wishlist.html">
                                        <i class="icon">
                                            <svg width="20" class="icon-20" height="20" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path opacity="0.4"
                                ...
                                <li class="nav-item">
                                    <a class="nav-link "
                                        href="https://templates.iqonic.design/hope-ui/pro/html/e-commerce/user-profile.html">
                                        <i class="icon">
                                            <svg width="20" class="icon-20" height="20" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                ...
                                <li class="nav-item">
                                    <a class="nav-link "
                                        href="https://templates.iqonic.design/hope-ui/pro/html/e-commerce/user-list.html">
                                        <i class="icon">
                                            <svg width="20" class="icon-20" height="20" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="sub-nav collapse" id="social" data-bs-parent="#sidebar-menu">
                                <li class="nav-item">
                                    <a class="nav-link "
                                        href="https://templates.iqonic.design/hope-ui/pro/html/social-app/index.html">
                                        <i class="icon">
                                            <svg width="20" class="icon-20" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path opacity="0.4"
                                ...
                                <li class="nav-item">
                                    <a class="nav-link " aria-current="page"
                                        href="https://templates.iqonic.design/hope-ui/pro/html/social-app/newsfeed.html">
                                        <i class="icon">
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="sub-nav collapse" id="friends" data-bs-parent="#social">
                                        <li class="nav-item">
                                            <a class="nav-link "
                                                href="https://templates.iqonic.design/hope-ui/pro/html/social-app/friend-list.html">
                                                <i class="icon">
                                                    <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <g>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link "
                                                href="https://templates.iqonic.design/hope-ui/pro/html/social-app/friend-request.html">
                                                <i class="icon">
                                                    <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <g>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link "
                                                href="https://templates.iqonic.design/hope-ui/pro/html/social-app/friend-profile.html">
                                                <i class="icon">
                                                    <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <g>
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="sub-nav collapse" id="profile" data-bs-parent="#social">
                                        <li class="nav-item">
                                            <a class="nav-link "
                                                href="https://templates.iqonic.design/hope-ui/pro/html/social-app/profile-badges.html">
                                                <i class="icon">
                                                    <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <g>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link "
                                                href="https://templates.iqonic.design/hope-ui/pro/html/social-app/profile-images.html">
                                                <i class="icon">
                                                    <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <g>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link "
                                                href="https://templates.iqonic.design/hope-ui/pro/html/social-app/profile-video.html">
                                                <i class="icon">
                                                    <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <g>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link "
                                                href="https://templates.iqonic.design/hope-ui/pro/html/social-app/birthday.html">
                                                <i class="icon">
                                                    <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <g>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link "
                                                href="https://templates.iqonic.design/hope-ui/pro/html/social-app/notification.html">
                                                <i class="icon">
                                                    <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <g>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link "
                                                href="https://templates.iqonic.design/hope-ui/pro/html/social-app/account-setting.html">
                                                <i class="icon">
                                                    <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <g>
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="sub-nav collapse" id="event" data-bs-parent="#social">
                                        <li class="nav-item">
                                            <a class="nav-link "
                                                href="https://templates.iqonic.design/hope-ui/pro/html/social-app/event-list.html">
                                                <i class="icon">
                                                    <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <g>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link "
                                                href="https://templates.iqonic.design/hope-ui/pro/html/social-app/event-detail.html">
                                                <i class="icon">
                                                    <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <g>
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="sub-nav collapse" id="group" data-bs-parent="#social">
                                        <li class="nav-item">
                                            <a class="nav-link "
                                                href="https://templates.iqonic.design/hope-ui/pro/html/social-app/group.html">
                                                <i class="icon">
                                                    <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <g>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link "
                                                href="https://templates.iqonic.design/hope-ui/pro/html/social-app/group-detail.html">
                                                <i class="icon">
                                                    <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <g>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link "
                                        href="https://templates.iqonic.design/hope-ui/pro/html/social-app/social-profile.html">
                                        <i class="icon">
                                            <svg width="20" class="icon-20" viewBox="0 0 24 24" fill="currentColor"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path opacity="0.4"
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="sub-nav collapse" id="blog" data-bs-parent="#sidebar-menu">
                                <li class="nav-item">
                                    <a class="nav-link "
                                        href="https://templates.iqonic.design/hope-ui/pro/html/blog/index.html">
                                        <i class="icon">
                                            <svg width="20" class="icon-20" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path opacity="0.4"
                                ...
                                <li class="nav-item ">
                                    ...
                                    <ul class="sub-nav collapse" id="blog1" data-bs-parent="#blog">
                                        <li class="nav-item">
                                            <a class="nav-link " aria-current="page"
                                                href="https://templates.iqonic.design/hope-ui/pro/html/blog/blog-main.html">
                                                <i class="icon">
                                                    <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <g>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link " aria-current="page"
                                                href="https://templates.iqonic.design/hope-ui/pro/html/blog/blog-detail.html">
                                                <i class="icon">
                                                    <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <g>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link " aria-current="page"
                                                href="https://templates.iqonic.design/hope-ui/pro/html/blog/blog-grid.html">
                                                <i class="icon">
                                                    <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <g>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link " aria-current="page"
                                                href="https://templates.iqonic.design/hope-ui/pro/html/blog/blog-list.html">
                                                <i class="icon">
                                                    <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <g>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link "
                                                href="https://templates.iqonic.design/hope-ui/pro/html/blog/blog-trending.html">
                                                <i class="icon">
                                                    <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <g>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link "
                                        href="https://templates.iqonic.design/hope-ui/pro/html/blog/blog-comments.html">
                                        <i class="icon">
                                            <svg width="20" class="icon-20" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path opacity="0.4"
                                ...
                                <li class="nav-item">
                                    <a class="nav-link " aria-current="page"
                                        href="https://templates.iqonic.design/hope-ui/pro/html/blog/blog-category.html">
                                        <i class="icon">
                                            <svg width="20" class="icon-20" viewBox="0 0 24 24" fill="currentColor"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path opacity="0.4" fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="sub-nav collapse" id="appointment" data-bs-parent="#sidebar-menu">
                                <li class="nav-item">
                                    <a class="nav-link "
                                        href="https://templates.iqonic.design/hope-ui/pro/html/appointment/index.html">
                                        <i class="icon">
                                            <svg width="20" class="icon-20" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path opacity="0.4"
                                ...
                                <li class="nav-item">
                                    <a class="nav-link "
                                        href="https://templates.iqonic.design/hope-ui/pro/html/appointment/book-appointment.html">
                                        <i class="icon">
                                            <svg width="20" class="icon-20" viewBox="0 0 24 24" fill="currentColor"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                ...
                                <li class="nav-item">
                                    <a class="nav-link "
                                        href="https://templates.iqonic.design/hope-ui/pro/html/appointment/doctor-visit.html">
                                        <i class="icon">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="sub-nav collapse" id="file-manager" data-bs-parent="#sidebar-menu">
                                <li class="nav-item">
                                    <a class="nav-link "
                                        href="https://templates.iqonic.design/hope-ui/pro/html/file-manager/index.html">
                                        <i class="icon">
                                            <svg width="20" class="icon-20" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path opacity="0.4"
                                ...
                                <li class="nav-item">
                                    <a class="nav-link "
                                        href="https://templates.iqonic.design/hope-ui/pro/html/file-manager/image-folder.html">
                                        <i class="icon">
                                            <svg width="20" class="icon-20" viewBox="0 0 24 24" fill="currentColor"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                ...
                                <li class="nav-item">
                                    <a class="nav-link "
                                        href="https://templates.iqonic.design/hope-ui/pro/html/file-manager/video-folder.html">
                                        <i class="icon">
                                            <svg width="20" class="icon-20" viewBox="0 0 24 24" fill="currentColor"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path opacity="0.4"
                                ...
                                <li class="nav-item">
                                    <a class="nav-link "
                                        href="https://templates.iqonic.design/hope-ui/pro/html/file-manager/document-folder.html">
                                        <i class="icon">
                                            <svg width="20" class="icon-20" viewBox="0 0 24 24" fill="currentColor"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path opacity="0.4"
                                ...
                                <li class="nav-item">
                                    <a class="nav-link " aria-current="page"
                                        href="https://templates.iqonic.design/hope-ui/pro/html/file-manager/all-files.html">
                                        <i class="icon">
                                            <svg width="20" class="icon-20" viewBox="0 0 24 24" fill="currentColor"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path opacity="0.4"
                                ...
                                <li class="nav-item">
                                    <a class="nav-link " aria-current="page"
                                        href="https://templates.iqonic.design/hope-ui/pro/html/file-manager/trash.html">
                                        <i class="icon">
                                            <svg width="20" class="icon-20" viewBox="0 0 24 24" fill="currentColor"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path opacity="0.4"
                        ...
                        <li class="nav-item">
                            <a class="nav-link " aria-current="page"
                                href="https://templates.iqonic.design/hope-ui/pro/html/chat/index.html" target="_blank">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="sub-nav collapse" id="mail" data-bs-parent="#sidebar-menu">
                                <li class="nav-item">
                                    <a class="nav-link " href="https://templates.iqonic.design/hope-ui/pro/html/mail/index.html">
                                        <i class="icon">
                                            <svg width="20" class="icon-20" viewBox="0 0 24 24" fill="currentColor"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path opacity="0.4"
                                ...
                                <li class="nav-item">
                                    <a class="nav-link "
                                        href="https://templates.iqonic.design/hope-ui/pro/html/mail/email-compose.html">
                                        <i class="icon">
                                            <svg width="20" class="icon-20" viewBox="0 0 24 24" fill="currentColor"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path opacity="0.4"
                   ...
                   <div class="container-fluid navbar-inner">
                      ...
                      <div class="d-flex align-items-center justify-content-between product-offcanvas">
                         <div class="breadcrumb-title border-end me-3 pe-3 d-none d-xl-block">
                            <small class="mb-0 text-capitalize">Button Hover</small>
                         </div>
                                        ...
                                        <li class="nav-item">
                                           ...
                                           <ul aria-expanded="false" class="iq-header-sub-menu left list-unstyled collapse"
                                              ...
                                              <li class="nav-item"><a
                                                    ...
                                                    href="button-hover.html">Button Hover</a></li>
                                              <li class="nav-item"><a
                                                    class="nav-link "
                                                    href="choise-js.html">Choise JS</a></li>
                                              <li class="nav-item"><a
                                                    class="nav-link "
                                                    href="fslightbox.html">FSlightbox</a></li>
                                              <li class="nav-item"><a
                                                    class="nav-link "
                                                    href="select2.html">Select2</a></li>
                                              <li class="nav-item"><a
                                                    class="nav-link "
                                                    href="sweet-alert.html">Sweetalert</a></li>
                                              <li class="nav-item"><a
                                                    class="nav-link "
                                                    href="flatpickr.html">flatpickr</a></li>
                                              <li class="nav-item"><a
                                                    class="nav-link "
                                                    href="apexcharts.html">Apexcharts</a></li>
                                              <li class="nav-item"><a
                                                    class="nav-link "
                                                    href="gallery-hover.html">Gallery Hover</a></li>
                                              <li class="nav-item"><a
                                                    class="nav-link "
                                                    href="image-croper.html">Image Croper</a></li>
                                              <li class="nav-item"><a
                                                    class="nav-link "
                                                    href="loader.html">Loader</a></li>
                                              <li class="nav-item"><a
                                                    class="nav-link "
                                                    href="rating.html">Rating</a></li>
                                              <li class="nav-item"><a
                                                    class="nav-link "
                                                    href="quill-editor.html">Quill</a></li>
                                              <li class="nav-item"><a class="nav-link "
                                                    href="uppy.html">Uppy</a></li>
                                           </ul>
                                        </li>
                                     </ul>
                                  </li>
                ...
                <div class="d-flex flex-wrap align-items-center justify-content-between">
                    <div class="d-flex flex-wrap align-items-center">
                        <div class="d-flex flex-wrap align-items-center mb-3 mb-sm-0">
                            <h4 class="me-2 h4">Hover Button</h4>
                        </div>
                    </div>
                    <small>For more Information regarding hover button Plugin refer
                        <a href="https://ianlunn.github.io/Hover/#effects">Documentation</a>
                    </small>
                </div>
            </div>
        </div>
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                <div class="header-title">
                    <h4 class="card-title">2D Transition</h4>
            ...
            <div class="card-body text-center">
                <div class="iq-plugins-btn">
                    <a href="#" class="me-4 btn btn-primary hvr-grow ">hvr-grow</a>
                    <a href="#" class="me-4 btn btn-primary hvr-shrink ">hvr-shrink</a>
                    <a href="#" class="me-4 btn btn-primary hvr-wobble-to-bottom-right">hvr-wobble-to-bottom-right</a>
                    <a href="#" class="me-4 btn btn-primary hvr-pulse">hvr-pulse</a>
                    <a href="#" class="me-4 btn btn-primary hvr-pulse-grow">hvr-pulse-grow</a>
                    <a href="#" class="me-4 btn btn-primary hvr-push">hvr-push</a>
                    <a href="#" class="me-4 btn btn-primary hvr-grow-rotate">hvr-grow-rotate</a>
                    <a href="#" class="me-4 btn btn-primary hvr-pop">hvr-pop</a>
                    <a href="#" class="me-4 btn btn-primary hvr-wobble-to-top-right">hvr-wobble-to-top-right</a>
                    <a href="#" class="me-4 btn btn-primary hvr-bounce-in">hvr-bounce-in</a>
                    <a href="#" class="me-4 btn btn-primary hvr-bounce-out">hvr-bounce-out</a>
                    <a href="#" class="me-4 btn btn-primary hvr-rotate">hvr-rotate</a>
                    <a href="#" class="me-4 btn btn-primary hvr-wobble-bottom">hvr-wobble-bottom</a>
                    <a href="#" class="me-4 btn btn-primary hvr-wobble-vertical">hvr-wobble-vertical</a>
                    <a href="#" class="me-4 btn btn-primary hvr-skew-forward">hvr-skew-forward</a>
                    <a href="#" class="me-4 btn btn-primary hvr-skew-backward">hvr-skew-backward</a>
                    <a href="#" class="me-4 btn btn-primary hvr-bob">hvr-bob</a>
                    <a href="#" class="me-4 btn btn-primary hvr-hang">hvr-hang</a>
                    <a href="#" class="me-4 btn btn-primary hvr-wobble-horizontal">hvr-wobble-horizontal</a>
                    <a href="#" class="me-4 btn btn-primary hvr-skew">hvr-skew</a>
                    <a href="#" class="me-4 btn btn-primary hvr-wobble-skew">hvr-wobble-skew</a>
                    <a href="#" class="me-4 btn btn-primary hvr-buzz">hvr-buzz</a>
                    <a href="#" class="me-4 btn btn-primary hvr-wobble-top">hvr-wobble-top</a>
                    <a href="#" class="me-4 btn btn-primary hvr-float">hvr-float</a>
                    <a href="#" class="me-4 btn btn-primary hvr-sink">hvr-sink</a>
                    <a href="#" class="me-4 btn btn-primary hvr-buzz-out">hvr-buzz-out</a>
                    <a href="#" class="me-4 btn btn-primary hvr-forward">hvr-forward</a>
                    <a href="#" class="me-4 btn btn-primary hvr-backward">hvr-backward</a>
                    <a href="#" class="me-4 btn btn-primary hvr-grow">hvr-grow</a>
                    <a href="#" class="me-4 btn btn-primary hvr-shrink">hvr-shrink</a>
                    <a href="#" class="me-4 btn btn-primary hvr-wobble-to-bottom-right">hvr-wobble-to-bottom-right</a>
                    <a href="#" class="me-4 btn btn-primary hvr-pulse">hvr-pulse</a>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                <div class="header-title">
                    <h4 class="card-title">Background Transitions</h4>
            ...
            <div class="card-body text-center">
                <div class="iq-plugins-btn">
                    <a href="#" class="me-4 btn btn-primary hvr-fade">Fade</a>
                    <a href="#" class="me-4 btn btn-primary hvr-sweep-to-right">Sweep To Right</a>
                    <a href="#" class="me-4 btn btn-primary hvr-sweep-to-left">Sweep To Left</a>
                    <a href="#" class="me-4 btn btn-primary hvr-sweep-to-bottom">Sweep To Bottom</a>
                    <a href="#" class="me-4 btn btn-primary hvr-sweep-to-top">Sweep To Top</a>
                    <a href="#" class="me-4 btn btn-primary hvr-bounce-to-right">Bounce To Right</a>
                    <a href="#" class="me-4 btn btn-primary hvr-bounce-to-left">Bounce To Left</a>
                    <a href="#" class="me-4 btn btn-primary hvr-bounce-to-bottom">Bounce To Bottom</a>
                    <a href="#" class="me-4 btn btn-primary hvr-bounce-to-top">Bounce To Top</a>
                    <a href="#" class="me-4 btn btn-primary hvr-rectangle-out">Rectangle Out</a>
                    <a href="#" class="me-4 btn btn-primary hvr-radial-out">Radial Out</a>
                    <a href="#" class="me-4 btn btn-primary hvr-shutter-out-horizontal">Shutter Out Horizontal</a>
                    <a href="#" class="me-4 btn btn-primary hvr-shutter-out-vertical">Shutter Out Vertical</a>
                </div>
            </div>
        </div>
    </div>
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body text-center">
                <div class="iq-plugins-btn">
                    <a href="#" class="me-4 btn btn-primary hvr-icon-back">
				    ...
				    <a href="#" class="me-4 btn btn-primary hvr-icon-forward">
					    Icon Forward
                        <svg class="size-28 hvr-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">                            
				    ...
				    <a href="#" class=" me-4 btn btn-primary hvr-icon-down">
					    Icon Down 
                        <svg class="size-28 hvr-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">                            
				    ...
				    <a href="#" class="me-4 btn btn-primary hvr-icon-up">
					    Icon Up 
                        <svg class="size-28 hvr-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">                            
				    ...
				    <a href="#" class="me-4 btn btn-primary hvr-icon-spin">
					    Icon Spin 
                        <svg class="size-28 hvr-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">                            
				    ...
				    <a href="#" class="me-4 btn btn-primary hvr-icon-drop">
					    Icon Drop 
                        <svg class="size-28 hvr-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">                            
				    ...
				    <a href="#" class="me-4 btn btn-primary hvr-icon-fade">
					    Icon Fade 
                        <svg class="size-28 hvr-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">                            
				    ...
				    <a href="#" class="me-4 btn btn-primary hvr-icon-float-away">
					    Icon Float Away 
                        <svg class="size-28 hvr-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">                            
				    ...
				    <a href="#" class="me-4 btn btn-primary hvr-icon-sink-away">
					    Icon Sink Away 
                        <svg class="size-28 hvr-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">                            
                    ...
                    <a href="#" class="me-4 btn btn-primary hvr-icon-wobble-vertical">
				    ...
				    <a href="#" class="me-4 btn btn-primary hvr-icon-grow">
					    Icon Grow 
                        <svg class="size-28 hvr-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">                            
				    ...
				    <a href="#" class="me-4 btn btn-primary hvr-icon-shrink">
					    Icon Shrink 
                        <svg class="size-28 hvr-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">                            
				    ...
				    <a href="#" class="me-4 btn btn-primary hvr-icon-pulse">
				    	Icon Pulse 
                        <svg class="size-28 hvr-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">                            
				    ...
				    <a href="#" class="me-4 btn btn-primary hvr-icon-pulse-grow">
					    Icon Pulse Grow 
                        <svg class="size-28 hvr-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">                            
                    ...
                    <a href="#" class="me-4 btn btn-primary hvr-icon-wobble-horizontal">
				    ...
				    <a href="#" class="me-4 btn btn-primary hvr-icon-pulse-shrink">
					    Icon Pulse Shrink 
                        <svg class="size-28 hvr-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">                            
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M11.7281 21.9137C11.8388 21.9715 11.9627 22.0009 12.0865 22C12.2103 21.999 12.3331 21.9686 12.4449 21.9097L16.0128 20.0025C17.0245 19.4631 17.8168 18.8601 18.435 18.1579C19.779 16.6282 20.5129 14.6758 20.4998 12.6626L20.4575 6.02198C20.4535 5.25711 19.9511 4.57461 19.2082 4.32652L12.5707 2.09956C12.1711 1.96424 11.7331 1.96718 11.3405 2.10643L4.72824 4.41281C3.9893 4.67071 3.496 5.35811 3.50002 6.12397L3.54231 12.7597C3.5554 14.7758 4.31448 16.7194 5.68062 18.2335C6.3048 18.9258 7.10415 19.52 8.12699 20.0505L11.7281 21.9137ZM10.7836 14.1089C10.9326 14.2521 11.1259 14.3227 11.3192 14.3207C11.5125 14.3198 11.7047 14.2472 11.8517 14.1021L15.7508 10.2581C16.0438 9.96882 16.0408 9.50401 15.7448 9.21866C15.4478 8.9333 14.9696 8.93526 14.6766 9.22454L11.3081 12.5449L9.92885 11.2191C9.63186 10.9337 9.15467 10.9367 8.8607 11.226C8.56774 11.5152 8.57076 11.98 8.86775 12.2654L10.7836 14.1089Z" fill="currentColor"></path>                            
                        </svg>                        
				    </a>
				    <a href="#" class="me-4 btn btn-primary hvr-icon-push">
					    Icon Push 
                        <svg class="size-28 hvr-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">                                
				    ...
				    <a href="#" class="me-4 btn btn-primary hvr-icon-pop">
					    Icon Pop 
                        <svg class="size-28 hvr-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">                            
				    ...
				    <a href="#" class="me-4 btn btn-primary hvr-icon-bounce">
					    Icon Bounce 
                        <svg class="size-28 hvr-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">                           
				...
				<a href="#" class="me-4 btn btn-primary hvr-icon-rotate">
					Icon Rotate 
                    <svg class="size-28 hvr-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">                            
				...
				<a href="#" class="me-4 btn btn-primary hvr-icon-grow-rotate">
					Icon Grow Rotate 
                    <svg class="size-28 hvr-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">                            
                        <path d="M6.5899 11.8585C6.71614 12.0925 6.95618 12.2384 7.21726 12.2384H11.2827V20.2657C11.2827 20.671 11.604 21 12 21C12.3959 21 12.7172 20.671 12.7172 20.2657V12.2384H16.7827C17.0447 12.2384 17.2848 12.0925 17.4101 11.8585C17.5372 11.6245 17.5286 11.3386 17.39 11.1125L12.6073 3.34267C12.4753 3.12924 12.2467 3 12 3C11.7532 3 11.5247 3.12924 11.3927 3.34267L6.60998 11.1125C6.5373 11.2319 6.5 11.368 6.5 11.5041C6.5 11.6255 6.5306 11.7479 6.5899 11.8585Z" fill="currentColor"></path>                            
                    </svg>  
				</a>
				<a href="#" class="me-4 btn btn-primary hvr-icon-float">
					Icon Float 
                    <svg class="size-28 hvr-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">                            
				...
				<a href="#" class="me-4 btn btn-primary hvr-icon-sink">
					Icon Sink 
                    <svg class="size-28 hvr-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">                            
				...
				<a href="#" class="me-4 btn btn-primary hvr-icon-bob">
					Icon Bob 
                    <svg class="size-28 hvr-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">                            
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M16.4184 6.47H16.6232C19.3152 6.47 21.5 8.72 21.5 11.48V17C21.5 19.76 19.3152 22 16.6232 22H7.3768C4.6848 22 2.5 19.76 2.5 17V11.48C2.5 8.72 4.6848 6.47 7.3768 6.47H7.58162C7.60113 5.27 8.05955 4.15 8.8886 3.31C9.72741 2.46 10.8003 2.03 12.0098 2C14.4286 2 16.3891 4 16.4184 6.47ZM9.91273 4.38C9.36653 4.94 9.06417 5.68 9.04466 6.47H14.9553C14.9261 4.83 13.6191 3.5 12.0098 3.5C11.2587 3.5 10.4784 3.81 9.91273 4.38ZM15.7064 10.32C16.116 10.32 16.4379 9.98 16.4379 9.57V8.41C16.4379 8 16.116 7.66 15.7064 7.66C15.3065 7.66 14.9748 8 14.9748 8.41V9.57C14.9748 9.98 15.3065 10.32 15.7064 10.32ZM8.93737 9.57C8.93737 9.98 8.6155 10.32 8.20585 10.32C7.80595 10.32 7.47433 9.98 7.47433 9.57V8.41C7.47433 8 7.80595 7.66 8.20585 7.66C8.6155 7.66 8.93737 8 8.93737 8.41V9.57Z" fill="currentColor"></path>                            
                    </svg>                        
				</a>
				<a href="#" class="me-4 btn btn-primary hvr-icon-hang">
					Icon Hang 
                    <svg class="size-28 hvr-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">                            
				...
				<a href="#" class="me-4 btn btn-primary hvr-icon-buzz">
					Icon Buzz 
                    <svg class="size-28 hvr-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">                            
				...
				<a href="#" class="me-4 btn btn-primary hvr-icon-buzz-out">
					Icon Buzz Out 
                    <svg class="size-28 hvr-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">                            
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                <div class="header-title">
                    <h4 class="card-title">Border Transitions</h4>
                    <p>In this method, selecting only one option from a lots of options while only using up as much
                        space as a single option excepted.</p>
                </div>
            </div>
            <div class="card-body text-center">
                <div class="iq-plugins-btn">
                    <a href="#" class="me-4 btn btn-primary hvr-border-fade">Border Fade</a>
                    <a href="#" class="me-4 btn btn-primary hvr-hollow">Hollow</a>
                    <a href="#" class="me-4 btn btn-primary hvr-trim">Trim</a>
                    <a href="#" class="me-4 btn btn-primary hvr-ripple-out">Ripple Out</a>
                    <a href="#" class="me-4 btn btn-primary hvr-ripple-in">Ripple In</a>
                    <a href="#" class="me-4 btn btn-primary hvr-outline-out">Outline Out</a>
                    <a href="#" class="me-4 btn btn-primary hvr-outline-in">Outline In</a>
                    <a href="#" class="me-4 btn btn-primary hvr-round-corners">Round Corners</a>
                    <a href="#" class="me-4 btn btn-primary hvr-underline-from-left">Underline From Left</a>
                    <a href="#" class="me-4 btn btn-primary hvr-underline-from-center">Underline From Center</a>
                    <a href="#" class="me-4 btn btn-primary hvr-underline-from-right">Underline From Right</a>
                    <a href="#" class="me-4 btn btn-primary hvr-reveal">Reveal</a>
                    <a href="#" class="me-4 btn btn-primary hvr-underline-reveal">Underline Reveal</a>
                    <a href="#" class="me-4 btn btn-primary hvr-overline-reveal">Overline Reveal</a>
                    <a href="#" class="me-4 btn btn-primary hvr-overline-from-left">Overline From Left</a>
                    <a href="#" class="me-4 btn btn-primary hvr-overline-from-center">Overline From Center</a>
                    <a href="#" class="me-4 btn btn-primary hvr-overline-from-right">Overline From Right</a>
                </div>
            </div>
        </div>
    </div>
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                <div class="header-title">
                    <h4 class="card-title">Shadow and Grow Transitions</h4>
                    <p>In this method, selecting only one option from a lots of options while only using up as much
                        space as a single option excepted.</p>
                </div>
            </div>
            <div class="card-body text-center">
                <div class="iq-plugins-btn">
                    <a href="#"  class="me-4 btn btn-primary hvr-shadow ">Shadow</a> 
                    <a href="#" class="me-4 btn btn-primary hvr-grow-shadow">Grow Shadow</a>
                    <a href="#" class="me-4 btn btn-primary hvr-float-shadow">Float Shadow</a>
                    <a href="#" class="me-4 btn btn-primary hvr-glow ">Glow</a>
                    <a href="#" class="me-4 btn btn-primary hvr-shadow-radial">Shadow Radial</a> 
                    <a href="#" class="me-4 btn btn-primary hvr-box-shadow-outset ">Box Shadow Outset</a>
                    <a href="#" class="me-4 btn btn-primary hvr-box-shadow-inset ">Box Shadow Inset</a>
                </div>
            </div>
        </div>
    </div>
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                <div class="header-title">
                    <h4 class="card-title">Speech Bubbles</h4>
            ...
            <div class="card-body text-center">
                <div class="iq-plugins-btn">
                    <a href="#" class="me-4 btn btn-primary hvr-bubble-top">Bubble Top</a>
                    <a href="#" class="me-4 btn btn-primary hvr-bubble-right">Bubble Right</a>
                    <a href="#" class="me-4 btn btn-primary hvr-bubble-bottom">Bubble Bottom</a>
                    <a href="#" class="me-4 btn btn-primary hvr-bubble-left">Bubble Left</a>
                    <a href="#" class="me-4 btn btn-primary hvr-bubble-float-top">Bubble Float Top</a>
                    <a href="#" class="me-4 btn btn-primary hvr-bubble-float-right">Bubble Float Right</a>
                    <a href="#" class="me-4 btn btn-primary hvr-bubble-float-bottom">Bubble Float Bottom</a>
                    <a href="#" class="me-4 btn btn-primary hvr-bubble-float-left">Bubble Float Left</a>
                </div>
            </div>
        </div>
    </div>
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body text-center">
                <div class="iq-plugins-btn hrv-curl">
                    <a href="#" class="me-4 btn btn-primary hvr-curl-top-left">Curl Top Left</a>
                    <a href="#" class="me-4 btn btn-primary hvr-curl-top-right">Curl Top Right</a>
                    <a href="#" class="me-4 btn btn-primary hvr-curl-bottom-right">Curl Bottom Right</a>
                    <a href="#" class="me-4 btn btn-primary hvr-curl-bottom-left">Curl Bottom Left</a>
                </div>
            </div>
        </div>
    </div>    
...
<!-- Mirrored from templates.iqonic.design/hope-ui/pro/html/dashboard/plugins/button-hover.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Jul 2023 04:39:50 GMT -->
</html>
