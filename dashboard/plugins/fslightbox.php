...
<!-- Mirrored from templates.iqonic.design/hope-ui/pro/html/dashboard/plugins/fslightbox.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Jul 2023 04:39:54 GMT -->
<head>
        <meta charset="utf-8">
                   ...
                   <div class="container-fluid navbar-inner">
                      ...
                      <div class="d-flex align-items-center justify-content-between product-offcanvas">
                         <div class="breadcrumb-title border-end me-3 pe-3 d-none d-xl-block">
                            <small class="mb-0 text-capitalize">FS Lightbox</small>
                         </div>
...
<div class="row">
        ...
        <div class="card">
            ...
            <div class="card-body text-center">
                <div class="d-grid gap-card grid-cols-3 iq-fslightbox-img">
                    <a data-fslightbox="gallery" href="../../assets/images/pro/plugins/img6.jpg">
                        <img src="../../assets/images/pro/plugins/img6.jpg" class="img-fluid bg-soft-primary rounded" alt="profile-image" loading="lazy">
                    </a>
                    <a data-fslightbox="gallery" href="../../assets/images/pro/plugins/img1.jpg">
                        <img src="../../assets/images/pro/plugins/img1.jpg" class="img-fluid bg-soft-primary rounded" alt="profile-image" loading="lazy">
                    </a>
                    <a data-fslightbox="gallery" href="../../assets/images/pro/plugins/img2.jpg">
                        <img src="../../assets/images/pro/plugins/img2.jpg" class="img-fluid bg-soft-primary rounded" alt="profile-image" loading="lazy">
                    </a>
                    <a data-fslightbox="gallery" href="../../assets/images/pro/plugins/img3.jpg">
                        <img src="../../assets/images/pro/plugins/img3.jpg" class="img-fluid bg-soft-primary rounded" alt="profile-image" loading="lazy">
                    </a>
                    <a data-fslightbox="gallery" href="../../assets/images/pro/plugins/img4.jpg">
                        <img src="../../assets/images/pro/plugins/img4.jpg" class="img-fluid bg-soft-primary rounded" alt="profile-image" loading="lazy">
                    </a>
                    <a data-fslightbox="gallery" href="../../assets/images/pro/plugins/img5.jpg">
                        <img src="../../assets/images/pro/plugins/img5.jpg" class="img-fluid bg-soft-primary rounded" alt="profile-image" loading="lazy">
                    </a>
                </div>
            </div>
        </div>
    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body text-center">
                <div class="d-grid gap-card grid-cols-3 iq-fslightbox-img">
                    <a data-fslightbox="html5-video" data-video-poster="../../assets/images/pro/plugins/img7.jpg"
                        href="https://templates.iqonic.design/hope-ui/pro/html/assets/images/pro/plugins/video-1.mp4">
                        <img src="../../assets/images/pro/plugins/img7.jpg" class="img-fluid bg-soft-primary rounded" alt="Milk Bottle Beside a Tree" loading="lazy">
                    </a>
                    <a data-fslightbox="html5-video" data-video-poster="../../assets/images/pro/plugins/img8.jpg"
                        href="https://templates.iqonic.design/hope-ui/pro/html/assets/images/pro/plugins/video-2.mp4">
                        <img src="../../assets/images/pro/plugins/img8.jpg" class="img-fluid bg-soft-primary rounded" alt="Close-Up of Plant With Green Leaves" loading="lazy">
                    </a>
                    <a data-fslightbox="html5-video" data-video-poster="../../assets/images/pro/plugins/img9.jpg"
                        href="https://templates.iqonic.design/hope-ui/pro/html/assets/images/pro/plugins/video-3.mp4">
                        <img src="../../assets/images/pro/plugins/img9.jpg" class="img-fluid bg-soft-primary rounded" alt="Seagulls Flying Against Blue Sky" style="height: 100%;" loading="lazy">
                    </a>
                </div>
            </div>
        </div>
            ...
            <div class="card-body text-center">
                <div class="d-grid gap-card grid-cols-3 iq-fslightbox-img">
                    <a data-fslightbox="gallery" href="https://www.youtube.com/watch?v=3nQNiWdeH2Q">
                        <img class="img-fluid bg-soft-primary rounded" src="../../assets/images/pro/plugins/img10.jpg" alt="Heroes Tonight - Fullscreen Lightbox" loading="lazy">
                    </a>
                    <a data-fslightbox="gallery" href="https://www.youtube.com/watch?v=TW9d8vYrVFQ">
                        <img class="img-fluid bg-soft-primary rounded" src="../../assets/images/pro/plugins/img11.jpg" alt="Sky High - Fullscreen Lightbox" loading="lazy">
                    </a>
                    <a data-fslightbox="gallery" href="https://www.youtube.com/watch?v=zyXmsVwZqX4">
                        <img class="img-fluid bg-soft-primary rounded" src="../../assets/images/pro/plugins/img12.jpg" alt="Why we lose - Fullscreen Lightbox" loading="lazy">
                    </a>
                </div>
            </div>
        </div>
...
<!-- Mirrored from templates.iqonic.design/hope-ui/pro/html/dashboard/plugins/fslightbox.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Jul 2023 04:40:00 GMT -->
</html>
