...
<!-- Mirrored from templates.iqonic.design/hope-ui/pro/html/dashboard/plugins/image-croper.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Jul 2023 04:40:06 GMT -->
<head>
        <meta charset="utf-8">
...
<link rel='stylesheet' href="../../assets/vendor/cropper/dist/cropper.min.css">
</link>
    </head>
    <body class="  ">
        <!-- loader Start -->
                   ...
                   <div class="container-fluid navbar-inner">
                      ...
                      <div class="d-flex align-items-center justify-content-between product-offcanvas">
                         <div class="breadcrumb-title border-end me-3 pe-3 d-none d-xl-block">
                            <small class="mb-0 text-capitalize">Image Croper</small>
                         </div>
...
<div class="row">
         ...
         <div class="card-header d-flex justify-content-between">
            ...
            <div class="header-action">
               <a href="https://github.com/fengyuanchen/cropperjs#getting-started" target="_blank"
                  data-bs-toggle="tooltip" title="Plugin Detail">Detail</a>
            </div>
         </div>
         <div class="card-body">
            <div class="row">
               <div class="col-md-9">
                  <div class="docs-demo">
                     <div class="img-container">
                        <img src="../../assets/images/pro/plugins/01.jpg" alt="Picture" class="img-fluid"
                           id="main-img" loading="lazy">
                     </div>
                  </div>
               </div>
               <div class="col-md-3">
               ...
               <div class="col-md-12">
                  <div class="row" id="actions">
                     <div class="col-md-9 docs-buttons my-2">
                              ...
                              <span class="docs-tooltip" data-bs-toggle="tooltip" title="cropper.clear()">
                                 <svg class="icon-16" width="16" viewBox="0 0 24 24" fill="none"
                                    ...
                                    <path d="M14.3955 9.59497L9.60352 14.387" stroke="currentColor" stroke-width="1.5"
                                       stroke-linecap="round" stroke-linejoin="round"></path>
                                    <path d="M14.3971 14.3898L9.60107 9.59277" stroke="currentColor" stroke-width="1.5"
                                       stroke-linecap="round" stroke-linejoin="round"></path>
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                       d="M16.3345 2.75024H7.66549C4.64449 2.75024 2.75049 4.88924 2.75049 7.91624V16.0842C2.75049 19.1112 4.63549 21.2502 7.66549 21.2502H16.3335C19.3645 21.2502 21.2505 19.1112 21.2505 16.0842V7.91624C21.2505 4.88924 19.3645 2.75024 16.3345 2.75024Z"
                                       stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                        ...
                        <div class="btn-group">
                           <button type="button" class="btn btn-primary btn-sm my-1" data-method="reset" title="Reset">
                        ...
                        <button type="button" class="btn btn-secondary btn-sm my-2" data-method="scale" data-option="-2"
                     ...
                     <div class="col-md-3 docs-toggles">
                        <div class="btn-group d-flex flex-nowrap pt-2" data-bs-toggle="buttons">
                           <label class="btn btn-primary btn-sm active">
                              <input type="radio" class="sr-only" id="aspectRatio1" name="aspectRatio"
                                 value="1.7777777777777777">
                              <span class="docs-tooltip" data-bs-toggle="tooltip" title="aspectRatio: 16 / 9">
                                 16:9
                              </span>
                           </label>
                           <label class="btn btn-primary btn-sm">
                              ...
                              <span class="docs-tooltip" data-bs-toggle="tooltip" title="aspectRatio: 4 / 3">
                                 4:3
                              </span>
                           </label>
                           <label class="btn btn-primary btn-sm">
                              <input type="radio" class="sr-only" id="aspectRatio3" name="aspectRatio" value="1">
                              <span class="docs-tooltip" data-bs-toggle="tooltip" title="aspectRatio: 1 / 1">
                                 1:1
                              </span>
                           </label>
                           <label class="btn btn-primary btn-sm">
                              ...
                              <span class="docs-tooltip" data-bs-toggle="tooltip" title="aspectRatio: 2 / 3">
                                 2:3
                              </span>
                           </label>
                           <label class="btn btn-primary btn-sm">
                              <input type="radio" class="sr-only" id="aspectRatio5" name="aspectRatio" value="NaN">
                              <span class="docs-tooltip" data-bs-toggle="tooltip" title="aspectRatio: NaN">
                                 Free
                              </span>
                           </label>
                        </div>
                        <div class="btn-group d-flex flex-nowrap pt-2" data-bs-toggle="buttons">
                           <label class="btn btn-primary btn-sm active">
                              ...
                              <span class="docs-tooltip" data-bs-toggle="tooltip" title="View Mode 0">
                                 VM0
                              </span>
                           </label>
                           <label class="btn btn-primary btn-sm">
                              <input type="radio" class="sr-only" id="viewMode1" name="viewMode" value="1">
                              <span class="docs-tooltip" data-bs-toggle="tooltip" title="View Mode 1">
                                 VM1
                              </span>
                           </label>
                           <label class="btn btn-primary btn-sm">
                              <input type="radio" class="sr-only" id="viewMode2" name="viewMode" value="2">
                              <span class="docs-tooltip" data-bs-toggle="tooltip" title="View Mode 2">
                                 VM2
                              </span>
                           </label>
                           <label class="btn btn-primary btn-sm">
                              <input type="radio" class="sr-only" id="viewMode3" name="viewMode" value="3">
                              <span class="docs-tooltip" data-bs-toggle="tooltip" title="View Mode 3">
                                 VM3
                              </span>
                           </label>
                        </div>
                        <div class="dropdown dropup docs-options pt-2">
                           <button class="btn btn-primary btn-sm btn-block dropdown-toggle" type="button"
                              id="toggleOptions" data-bs-toggle="dropdown" aria-expanded="false">
                              Toggle Options
                        ...
                        <a class="btn btn-primary btn-sm my-2 btn-block pt-2" data-bs-toggle="tooltip"
   ...
   <div class="col-md-12">
      <div class="card">
            ...
            <div class="row">
               <div class="col-md-6 text-center">
                  <div class="croppy-round">
                     <img src="../../assets/images/pro/plugins/01.jpg" alt="picture" class="img-fluid" id="round-crop"
                        loading="lazy">
                  </div>
        ...
        <script src="../../assets/js/sidebard1f1.js?v=2.2.0" defer></script><script src="../../assets/js/plugins/image-croper.js"></script>
<script src="../../assets/vendor/cropper/dist/cropper.min.js"></script>
    </body>

<!-- Mirrored from templates.iqonic.design/hope-ui/pro/html/dashboard/plugins/image-croper.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Jul 2023 04:40:10 GMT -->
</html>
