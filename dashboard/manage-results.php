...
$query = "SELECT candidate_id, fname, lname FROM tblcandidate";
$result = mysqli_query($con, $query);
...
// Fetch region data
$query = "SELECT region_id, region_name FROM tblregion";
$result = mysqli_query($con, $query);
                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <div class="header-title">
                                <h4 class="card-title">Add New Resut</h4>
                            </div>
                        </div>
                        <div class="card-body">
                        <form method="post" enctype="multipart/form-data">
                                    ...
                                    <select class="form-select" id="candidate" name="candidate" required="">
                                        ...
                                        <?php foreach ($candidates as $candidate): ?>
                                            <option value="<?php echo $candidate['candidate_id']; ?>">
                                                <?php echo $candidate['fname'] . ' ' . $candidate['lname']; ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                                ...
                                <div class="form-group col-md-12">
                                    <label class="form-label" for="fname">Electoral Officer:</label>
                                    <input type="text" class="form-control" id="officer" placeholder="Electoral Officer"
                                        name="officer" required="">
                                </div>

                                <div class="form-group col-md-12">
                                    <label class="form-label" for="fname">Results:</label>
                                    <input type="number" class="form-control" id="fname" placeholder="Results"
