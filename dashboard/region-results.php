...
<div class="container-fluid content-inner pb-0" id="page_layout">
    <?php
    $region_id = $_GET['region_id']; // Get the region_id from the URL parameter

    // Fetch region name based on region_id
    $regionNameQuery = "SELECT region_name FROM tblregion WHERE region_id = $region_id";
    $regionNameResult = mysqli_query($con, $regionNameQuery);
    $regionNameRow = mysqli_fetch_assoc($regionNameResult);
    $regionName = $regionNameRow['region_name'];
    ?>

<div>
    <h4 class="mb-3"><?php echo strtoupper($regionName); ?></h4>
</div>
    ...
    <div class="row">
        ...
        WHERE tr.region_id = $region_id"; // Use the region_id in the WHERE clause
