            ...
            <div class="row">
                <div class="col-xl-3 col-lg-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                        <form method="post" action="save_region.php">
    <div class="form-group col-md-12">
        <label class="form-label" for="fname">Name of Region:</label>
        <input type="text" class="form-control" name="region_name" placeholder="Name of Region" >
    </div>
    <div class="form-group col-md-12">
        <label class="form-label" for="lname">Language:</label>
...
while ($row = mysqli_fetch_assoc($result)) {
    echo '<tr>
            ...
            <td>
                                    ...
                                    <a class="btn btn-primary btn-icon btn-sm rounded-pill ms-2" href="edit-region.php?region_id=' . $row['region_id'] . '" role="button">
                                            <span class="btn-inner">
                                        ...
                                        <a class="btn btn-primary btn-icon btn-sm rounded-pill ms-2" href="#" role="button" onclick="confirmDelete(' . $row['region_id'] . ')">
                                            <span class="btn-inner">
                                                <svg class="icon-32" width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
function confirmDelete(regionId) {
    ...
    if (result) {
        ...
        window.location.href = "delete-candidate.php?region_id=" + regionId;
    }
}
</script>
            </div>
