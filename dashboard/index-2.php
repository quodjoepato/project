...
<!-- Mirrored from templates.iqonic.design/hope-ui/pro/html/dashboard/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Jul 2023 04:40:36 GMT -->
<head>
        <meta charset="utf-8">
                    ...
                    <div class="col-md-6">
                        <div class="iq-scroller-effect">
                            ...
                            <div class="d-flex align-items-center iq-slider mb-4 gap-2">
                                <div>
                                    <img class="rounded-circle bg-soft-primary img-fluid avatar-40 mb-2" src="../assets/images/table/1.png" alt="profile" loading="lazy" />
                                </div>
                                <div>
                                    <img class="rounded-circle bg-soft-primary img-fluid avatar-40 mb-2" src="../assets/images/table/2.png" alt="profile" loading="lazy" />
                                </div>
                                <div>
                                    <img class="rounded-circle bg-soft-primary img-fluid avatar-40 mb-2" src="../assets/images/table/3.png" alt="profile" loading="lazy" />
                                </div>
                                <div>
                                    <img class="rounded-circle bg-soft-primary img-fluid avatar-40 mb-2" src="../assets/images/table/4.png" alt="profile" loading="lazy" />
                                </div>
                                <div>
                                    <img class="rounded-circle bg-soft-primary img-fluid avatar-40 mb-2" src="../assets/images/table/5.png" alt="profile" loading="lazy" />
                                </div>
                            </div>
                            <div>
...
<!-- Mirrored from templates.iqonic.design/hope-ui/pro/html/dashboard/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Jul 2023 04:40:37 GMT -->
</html>
