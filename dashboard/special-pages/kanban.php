...
<!-- Mirrored from templates.iqonic.design/hope-ui/pro/html/dashboard/special-pages/kanban.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Jul 2023 04:39:26 GMT -->
<head>
        <meta charset="utf-8">
                   ...
                   <div class="container-fluid navbar-inner">
                      ...
                      <div class="d-flex align-items-center justify-content-between product-offcanvas">
                         <div class="breadcrumb-title border-end me-3 pe-3 d-none d-xl-block">
                            <small class="mb-0 text-capitalize">Kanban</small>
                         </div>
                                     ...
                                     <ul class="iq-header-sub-menu list-unstyled collapse" id="allPagesData">
                                        <li class="nav-item">
                                           ...
                                           <ul aria-expanded="false" class="iq-header-sub-menu left list-unstyled collapse"
                                              ...
                                              <li class="nav-item"><a
                                                    class="nav-link "
                                                    href="billing.html">Billing</a></li>
                                              <li class="nav-item"><a
                                                    class="nav-link "
                                                    href="calender.html">Calender</a></li>
                                              <li class="nav-item"><a
                                                    class="nav-link active"
                                                    href="kanban.html">Kanban</a></li>
                                              <li class="nav-item"><a
                                                    class="nav-link "
                                                    href="pricing.html">Pricing</a></li>
                                              <li class="nav-item"><a
                                                    class="nav-link "
                                                    href="timeline.html">Timeline</a></li>
                                           </ul>
                                        </li>
                                        <li class="nav-item">
...
<div class="row">
                ...
                <div class="row">
                    ...
                    <div class="group1-wrap">
                        <div class="group" id="group1">
                            ...
                            </div>                            <div class="col-lg-12 group__item">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-grid grid-flow-col align-items-center justify-content-between mb-2">
                                            <div class="d-flex align-items-center">
    ...
    <div class="col-lg-3">
        ...
        <script src="../../assets/js/sidebard1f1.js?v=2.2.0" defer></script><script src="../../assets/vendor/sortable/Sortable.min.js"></script>
<script src="../../assets/js/plugins/kanban.js"></script>
    </body>

<!-- Mirrored from templates.iqonic.design/hope-ui/pro/html/dashboard/special-pages/kanban.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Jul 2023 04:39:28 GMT -->
</html>
