...
<!-- Mirrored from templates.iqonic.design/hope-ui/pro/html/dashboard/index-dual-horizontal.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Jul 2023 04:39:18 GMT -->
<head>
    <meta charset="utf-8">
      <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
      <title data-setting="app_name" data-rightJoin=" Pro Dual Horizontal | Responsive Bootstrap 5 Admin Dashboard Template">Hope UI Pro Dual Horizontal | Responsive Bootstrap 5 Admin Dashboard Template</title>
      ...
      <meta name="keywords" content="premium, admin, dashboard, template, bootstrap 5, clean ui, hope ui, admin dashboard,responsive dashboard, optimized dashboard, dual horizontal">
      <meta name="author" content="Iqonic Design">
      <meta name="DC.title" content="Hope UI Pro Dual Horizontal | Responsive Bootstrap 5 Admin Dashboard Template">
      <!-- Google Font Api KEY-->
      ...
      <nav class="nav navbar navbar-expand-xl navbar-light iq-navbar">
        <div class="container-fluid navbar-inner">
          ...
          <a href="index.html" class="navbar-brand">
              ...
              <!--logo End-->
              <h4 class="logo-title d-none d-sm-block" data-setting="app_name">Hope UI</h4>
          </a>
      ...
      <div class="navbar dual-horizontal">
        ...
        <div class="container-fluid">
           ...
           <ul class="navbar-nav">
              ...
              <li class="nav-item"><a class="nav-link active" href="index-dual-horizontal.html"> Dual Horizontal </a></li>
