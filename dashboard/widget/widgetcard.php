...
<!-- Mirrored from templates.iqonic.design/hope-ui/pro/html/dashboard/widget/widgetcard.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Jul 2023 04:40:23 GMT -->
<head>
        <meta charset="utf-8">
                   ...
                   <div class="container-fluid navbar-inner">
                      ...
                      <div class="d-flex align-items-center justify-content-between product-offcanvas">
                         <div class="breadcrumb-title border-end me-3 pe-3 d-none d-xl-block">
                            <small class="mb-0 text-capitalize">Widget Card</small>
                         </div>
                                     ...
                                     <ul class="iq-header-sub-menu list-unstyled collapse" id="elementsData">
                                        ...
                                        <li class="nav-item">
                                           ...
                                           <ul aria-expanded="false" class="iq-header-sub-menu left list-unstyled collapse"
                                              ...
                                              <li class="nav-item"><a
                                                    class="nav-link "
                                                    href="widgetbasic.html">Widget Basic</a></li>
                                              <li class="nav-item"><a
                                                    class="nav-link "
                                                    href="widgetchart.html">Widget Chart</a></li>
                                              <li class="nav-item"><a
                                                    class="nav-link active"
                                                    href="widgetcard.html">Widget Card</a></li>
                                           </ul>
                                        </li>
                                        <li class="nav-item">
                        ...
                        <div class="d-flex align-items-center justify-content-center">
                            <div class="d-flex flex-column text-center align-items-center justify-content-between ">
                                ...
                                <div class="card-profile-progress">
                                    ...
                                    <img src="../../assets/images/avatars/avtar_1.png" alt="User-Profile" class="theme-color-purple-img img-fluid rounded-circle card-img" loading="lazy" />
                                    <img src="../../assets/images/avatars/avtar_2.png" alt="User-Profile" class="theme-color-blue-img img-fluid rounded-circle card-img" loading="lazy" />
                                    <img src="../../assets/images/avatars/avtar_4.png" alt="User-Profile" class="theme-color-green-img img-fluid rounded-circle card-img" loading="lazy" />
                                    <img src="../../assets/images/avatars/avtar_5.png" alt="User-Profile" class="theme-color-yellow-img img-fluid rounded-circle card-img" loading="lazy" />
                                    <img src="../../assets/images/avatars/avtar_3.png" alt="User-Profile" class="theme-color-pink-img img-fluid rounded-circle card-img" loading="lazy" />  
                                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex  justify-content-start align-items-center mb-3">
                            <div class="pe-3">
                                <img src="../../assets/images/avatars/02.png" class="rounded-circle p-1 bg-soft-danger" width="60" height="60" alt="1" loading="lazy" />
                            </div>
                            <div>
                                <h5  >Web Workshop</h5>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-start align-items-center">
                            <div class="pe-3">
                                <img src="../../assets/images/avatars/03.png" class="rounded-circle bg-soft-primary p-1" width="50" height="50" alt="1" loading="lazy" />
                            </div>
                            <div>
                        ...
                        <div class="d-flex justify-content-start align-items-center mt-4">
                            <div class="pe-3">
                                <img src="../../assets/images/avatars/04.png" class="rounded-circle bg-soft-danger p-1" width="50" height="50" alt="1" loading="lazy" />
                            </div>
                            <div>
                        ...
                        <div class="d-flex justify-content-start align-items-center mt-4">
                            <div class="pe-3">
                                <img src="../../assets/images/avatars/05.png" class="rounded-circle bg-soft-info p-1" width="50" height="50" alt="1" loading="lazy" />
                            </div>
                            <div>
                        ...
                        <div class="d-flex justify-content-start align-items-center mt-4">
                            <div class="pe-3">
                                <img src="../../assets/images/avatars/02.png" class="rounded-circle bg-soft-danger p-1" width="50" height="50" alt="1" loading="lazy" />
                            </div>
                            <div>
                        ...
                        <div class="user-post-data">
                            <div class="d-flex flex-wrap">
                                <div class="media-support-user-img me-3">
                                    <img class="rounded-circle p-1 bg-soft-danger img-fluid avatar-60" src="../../assets/images/avatars/02.png" alt="" loading="lazy" />
                                </div>
                        ...
                        <div class="comment-area mt-3">
                            ...
                            <ul class="post-comments p-0 list-inline">
                                <li class="mb-3">
                                    <div class="d-flex flex-wrap">
                                        <div class="user-img">
                                            <img src="../../assets/images/avatars/03.png" alt="userimg" class="p-1 bg-soft-primary avatar-60 rounded-circle img-fluid" loading="lazy" />
                                        </div>
                    ...
                    <div class="card-body">
                        <ul class="media-story m-0 p-0">
                            ...
                            <li class="d-flex mb-4 align-items-center">
                                <img src="../../assets/images/avatars/02.png" alt="story-img" class="avatar-50 rounded-circle p-1 bg-soft-danger img-fluid" loading="lazy" />
                                <div class="stories-data ms-3">
                                    <h5>Ira Membrit</h5>
                            ...
                            <li class="d-flex align-items-center">
                                <img src="../../assets/images/avatars/03.png" alt="story-img" class="avatar-50 rounded-circle p-1 bg-soft-primary img-fluid" loading="lazy" />
                                <div class="stories-data ms-3">
                                    <h5>Bob Frapples</h5>
            ...
            <div class="col-lg-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="twit-feed">
                            <div class="d-flex align-items-center mb-4">
                                <img class="rounded-pill p-1 bg-soft-primary img-fluid avatar-60 me-3" src="../../assets/images/avatars/03.png" alt="" loading="lazy" />
                                <div class="media-support-info">
...
<!-- Mirrored from templates.iqonic.design/hope-ui/pro/html/dashboard/widget/widgetcard.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Jul 2023 04:40:24 GMT -->
</html>
