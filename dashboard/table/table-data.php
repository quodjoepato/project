...
<!-- Mirrored from templates.iqonic.design/hope-ui/pro/html/dashboard/table/table-data.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Jul 2023 04:40:28 GMT -->
<head>
        <meta charset="utf-8">
         ...
         <div class="card-body">
            ...
            <div class="table-responsive  ">
               <select id="langSelector" class="form-control mb-3">
                  <option value="german" id="german" data-path="../../assets/vendor/language/german.json">German</option>
                  <option value="french" id="french" data-path="../../assets/vendor/language/french.json">French</option>
                  <option value="hindi" id="hindi" data-path="../../assets/vendor/language/hindi.json">Hindi</option>
                  <option value="japanase" id="japanase" data-path="../../assets/vendor/language/japanese.json">Japanese</option>
                  <option value="eng" id="english" data-path="../../assets/vendor/language/english.json">English</option>
               </select>
...
<!-- Mirrored from templates.iqonic.design/hope-ui/pro/html/dashboard/table/table-data.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Jul 2023 04:40:29 GMT -->
</html>
