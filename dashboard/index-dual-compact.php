...
<!-- Mirrored from templates.iqonic.design/hope-ui/pro/html/dashboard/index-dual-compact.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Jul 2023 04:39:18 GMT -->
<head>
    <meta charset="utf-8">
      <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
      <title data-setting="app_name" data-rightJoin=" Pro Dual Compact | Responsive Bootstrap 5 Admin Dashboard Template">Hope UI Pro Dual Compact | Responsive Bootstrap 5 Admin Dashboard Template</title>
      ...
      <meta name="keywords" content="premium, admin, dashboard, template, bootstrap 5, clean ui, hope ui, admin dashboard,responsive dashboard, optimized dashboard, dual compact">
      <meta name="author" content="Iqonic Design">
      <meta name="DC.title" content="Hope UI Pro Dual Compact | Responsive Bootstrap 5 Admin Dashboard Template">
      <!-- Google Font Api KEY-->
    ...
    <main class="main-content">
      ...
      <nav class="navbar navbar-expand-lg fixed-top navbar-dark bg-dark iq-navbar" aria-label="Main navigation">
        <div class="container-fluid">
          <a href="index.html" class="navbar-brand d-flex align-items-center ms-0">
              ...
              <!--logo End-->        <h4 class="logo-title text-light ms-3 mb-0 d-none d-sm-block" data-setting="app_name">Hope UI</h4>
          </a>
