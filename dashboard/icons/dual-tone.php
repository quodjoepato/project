...
<!-- Mirrored from templates.iqonic.design/hope-ui/pro/html/dashboard/icons/dual-tone.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Jul 2023 04:40:34 GMT -->
<head>
        <meta charset="utf-8">
                   ...
                   <div class="container-fluid navbar-inner">
                      ...
                      <div class="d-flex align-items-center justify-content-between product-offcanvas">
                         <div class="breadcrumb-title border-end me-3 pe-3 d-none d-xl-block">
                            <small class="mb-0 text-capitalize">Dual tone Icons</small>
                         </div>
                                     ...
                                     <ul class="iq-header-sub-menu list-unstyled collapse" id="elementsData">
                                        ...
                                        <li class="nav-item">
                                           ...
                                           <ul aria-expanded="false" class="iq-header-sub-menu left list-unstyled collapse"
                                              ...
                                              <li class="nav-item"><a
                                                    class="nav-link "
                                                    href="solid.html">Solid</a></li>
                                              <li class="nav-item"><a
                                                    class="nav-link "
                                                    href="outline.html">Outlined</a></li>
                                              <li class="nav-item"><a
                                                    class="nav-link active"
                                                    href="dual-tone.html">Dual Tone</a></li>
                                           </ul>
                                        </li>
                                     </ul>
                                  </li>
...
<div class="row">
    <div class="col-lg-12">
        ...
        <script src="../../assets/js/sidebard1f1.js?v=2.2.0" defer></script><script src="../../assets/js/dual-tone-icon-search-filter.js"></script>
    </body>

<!-- Mirrored from templates.iqonic.design/hope-ui/pro/html/dashboard/icons/dual-tone.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Jul 2023 04:40:35 GMT -->
</html>
