...
if (isset($_POST['submit'])) {
    ...
    if (isset($_FILES['image']) && $_FILES['image']['error'] === UPLOAD_ERR_OK) {
        ...
        $image_path = '../assets/images/avatars/' . $image_name;
        move_uploaded_file($image_tmp, $image_path);
    } else {
        // Default image if no image is uploaded
        $image_path = '../assets/images/avatars/1.png';
    }

    // Insert the data into tblcandidate
    $sql = "INSERT INTO tblcandidate (fname, lname, image, slogan)
            VALUES ('$fname',  '$lname', '$image_path', '$slogan')";

    $result = mysqli_query($con, $sql);

    if ($result) {
        echo '<script>alert("User added successfully."); window.location.href = "manage-candidate.php";</script>';
        exit();
    } else {
                        ...
                        <div class="card-body">
                            <form method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="fname" name="slogan"
                                        placeholder="Slogan">
                                </div>
                                <div class="form-group col-md-12">
                                    ...
                                    <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    href="edit-candidate.php?candidate_id=<?php echo $row['candidate_id']; ?>" role="button">
                                                            <span class="btn-inner">
                                                        ...
                                                        <a class="btn btn-primary btn-icon btn-sm rounded-pill ms-2" href="" role="button" onclick="confirmDelete(<?php echo $row['candidate_id']; ?>)">
                                                            <span class="btn-inner">
                                                                <svg class="icon-32" width="32" viewbox="0 0 24 24"
                                                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                    <path opacity="0.4"
...
function confirmDelete(candidateId) {
    ...
    if (result) {
        ...
        window.location.href = "delete-candidate.php?candidate_id=" + candidateId;
    }
}
</script>
