<aside class="sidebar sidebar-base " id="first-tour" data-toggle="main-sidebar"
    ...
    <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
        ...
        <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="user-index.php">
    ...
    <path d="M9.14373 20.7821V17.7152C9.14372 16.9381 9.77567 16.3067 10.5584 16.3018H13.4326C14.2189 16.3018 14.8563 16.9346 14.8563 17.7152V20.7732C14.8562 21.4473 15.404 21.9951 16.0829 22H18.0438C18.9596 22.0023 19.8388 21.6428 20.4872 21.0007C21.1356 20.3586 21.5 19.4868 21.5 18.5775V9.86585C21.5 9.13139 21.1721 8.43471 20.6046 7.9635L13.943 2.67427C12.7785 1.74912 11.1154 1.77901 9.98539 2.74538L3.46701 7.9635C2.87274 8.42082 2.51755 9.11956 2.5 9.86585V18.5686C2.5 20.4637 4.04738 22 5.95617 22H7.87229C8.19917 22.0023 8.51349 21.8751 8.74547 21.6464C8.97746 21.4178 9.10793 21.1067 9.10792 20.7821H9.14373Z" fill="currentColor"></path>
        ...
        <li class="nav-item static-item">
            <a class="nav-link static-item disabled text-start" href="#" tabindex="-1">
                <span class="default-icon">View Results</span>
                <span class="mini-icon">-</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="all-candidates.php" role="button" aria-controls="sidebar-user">
    ...
    <path d="M3.32156 13.5127C2.21752 13.7297 1.49225 14.1719 1.19139 14.8167C0.936203 15.3453 0.936203 15.9586 1.19139 16.4872C1.65163 17.4851 3.13531 17.8066 3.71195 17.8885C3.83104 17.9065 3.92595 17.8038 3.91342 17.6832C3.61883 14.9167 5.9621 13.6046 6.56918 13.3029C6.59425 13.2885 6.59962 13.2677 6.59694 13.2542C6.59515 13.2452 6.5853 13.2317 6.5656 13.2299C5.25294 13.2047 3.84358 13.3848 3.32156 13.5127Z" fill="currentColor"></path>
                ...
                <span class="item-name">Manage Candidate</span>
            </a>
        </li>

        <li class="nav-item">
            <a class="nav-link" href="all-regions.php" role="button" aria-controls="sidebar-maps">
    ...
    <ellipse opacity="0.4" cx="12" cy="21" rx="5" ry="1" fill="currentColor"></ellipse>
                ...
                <span class="item-name">Manage Regions</span>
            </a>
        </li>
        ...
        <li class="nav-item" hidden>
            <a class="nav-link" data-bs-toggle="collapse" href="#utilities-error" role="button" aria-expanded="false"
                ...
                <span class="item-name">Manage Constituencies</span>
                <i class="right-icon">
            ...
            <ul class="sub-nav collapse" id="utilities-error" data-bs-parent="#sidebar-menu">
                <li class="nav-item">
                    <a class="nav-link " href="errors/error404.php">
                        ...
                        <span class="item-name">Add Constituency</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " href="errors/error500.php">
                        ...
                        <span class="item-name">All Constituencies</span>
                    </a>
                </li>
            </ul>
        </li>
        <li class="nav-item" hidden>
            <a class="nav-link" data-bs-toggle="collapse" href="#utilities-erro" role="button" aria-expanded="false"
                aria-controls="utilities-error">
                <i class="icon" data-bs-toggle="tooltip" title="Utilities" data-bs-placement="right">
                    <svg width="20" class="icon-20" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path opacity="0.4"
                ...
                <span class="item-name">Manage Polling Stations</span>
                <i class="right-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" class="icon-18" fill="none" viewbox="0 0 24 24"
                        stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
            ...
            <ul class="sub-nav collapse" id="utilities-erro" data-bs-parent="#sidebar-menu">
                <li class="nav-item">
                    <a class="nav-link " href="errors/error404.php">
                        <i class="icon" data-bs-toggle="tooltip" title="Error 404" data-bs-placement="right">
                            <svg class="icon-10" width="10" viewbox="0 0 24 24" fill="currentColor"
                        ...
                        <span class="item-name">Add Polling Station</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " href="errors/error500.php">
                        ...
                        <span class="item-name">All Polling Stations</span>
                    </a>
                </li>
            </ul>
        </li>
        <li class="nav-item" hidden>
            <a class="nav-link" href="manage-users.php" role="button" aria-controls="sidebar-user">
                <i class="icon" data-bs-toggle="tooltip" title="Users" data-bs-placement="right">
                <svg width="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M21.779 15.1693C21.4316 14.4439 20.593 13.9465 19.3171 13.7022C18.7153 13.5585 17.0852 13.3544 15.5695 13.3831C15.547 13.386 15.5343 13.4013 15.5324 13.4109C15.5294 13.4262 15.5363 13.4492 15.5656 13.4655C16.2662 13.8047 18.9737 15.2804 18.6332 18.3927C18.6185 18.5288 18.729 18.6438 18.867 18.6246C19.5333 18.5317 21.2476 18.1704 21.779 17.0474C22.0735 16.4533 22.0735 15.7634 21.779 15.1693Z" fill="currentColor"></path>
        ...
        <li class="nav-item static-item" hidden>
            <a class="nav-link static-item disabled text-start" href="#" tabindex="-1">
                <span class="default-icon">Results</span>
                <span class="mini-icon">-</span>
            </a>
        </li>

        <li class="nav-item" hidden>
            <a class="nav-link" href="manage-results.php" role="button" aria-controls="sidebar-user">
                <i class="icon" data-bs-toggle="tooltip" title="Users" data-bs-placement="right">
                     <svg width="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <circle opacity="0.4" cx="19.5" cy="4.5" r="2.5" fill="currentColor"></circle>
                ...
                <span class="item-name">Manage Results</span>
            </a>
        </li>
    </ul>
