...
<!-- Mirrored from templates.iqonic.design/hope-ui/pro/html/dashboard/auth-pro/sign-up.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Jul 2023 04:39:33 GMT -->
<head>
    <meta charset="utf-8">
        ...
        <nav class="navbar iq-auth-logo"> 
            <div class="container-fluid">
                <a href="../index-2.html" class="iq-link d-flex align-items-center">
                    <img src="https://templates.iqonic.design/hope-ui/pro/html/assets/images/favicon.ico" alt="logo" loading="lazy" />
            ...
            <div class="col-10 col-lg-4 offset-lg-7 offset-1">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="text-center">Already have an Account<a href="sign-in.html" class="ms-2">Sign in</a></p>
                    </div>
                </div>
            </div>
        </div>
