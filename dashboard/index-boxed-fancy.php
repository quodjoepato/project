...
<!-- Mirrored from templates.iqonic.design/hope-ui/pro/html/dashboard/index-boxed-fancy.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Jul 2023 04:39:18 GMT -->
<head>
    <meta charset="utf-8">
      <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
      <title data-setting="app_name" data-rightJoin=" Pro Boxed Fancy | Responsive Bootstrap 5 Admin Dashboard Template">Hope UI Pro Boxed Fancy | Responsive Bootstrap 5 Admin Dashboard Template</title>
      ...
      <meta name="keywords" content="premium, admin, dashboard, template, bootstrap 5, clean ui, hope ui, admin dashboard,responsive dashboard, optimized dashboard, boxed fancy">
      <meta name="author" content="Iqonic Design">
      <meta name="DC.title" content="Hope UI Pro Boxed Fancy | Responsive Bootstrap 5 Admin Dashboard Template">
      <!-- Google Font Api KEY-->
      ...
      <main class="main-content">
        ...
        <nav class="nav navbar navbar-expand-xl navbar-light iq-navbar">
          <div class="container-fluid navbar-inner">
            <button data-trigger="navbar_main" class="d-lg-none btn btn-sm btn-primary btn-icon rounded-pill" type="button">
            ...
            <a href="index.html" class="logo-center navbar-brand col-md-3 col-lg-3 ms-0">
                ...
                <!--logo End-->        <h4 class="logo-title d-none d-sm-block" data-setting="app_name">Hope UI</h4>
            </a>
            ...
            <div class="container-fluid">
               ...
               <ul class="navbar-nav">
                  <li class="nav-item"><a class="nav-link " href="index-horizontal.html"> Horizontal </a></li>
